...
Default: **full**. Switch: `/caveman lite|full|ultra|wenyan-lite|wenyan-full|wenyan-ultra|off`. Setting a level scopes it to THIS session only, even if other sessions are on a different level — `/caveman default` reverts this session back to following the shared default.
